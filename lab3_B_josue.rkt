...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname lab3_B_josue) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp")))))
...
;;exemplo:
;;(inf-tipo 'moderada lista-infracoes1)

(define(inf-tipo tipo lista-infracoes)
  (cond
    [(empty? lista-infracoes) empty]
    [(symbol=? (infracao-tipo (first lista-infracoes)) tipo)(cons(infracao-numero (first lista-infracoes))(inf-tipo tipo (first lista-infracoes)))]
    [else (inf-tipo tipo (rest lista-infracoes))]))
;;first: expects a non-empty list; given: (make-infracao 200 "02VVA" "iar8825" "10:25" 20140104 'moderada)???
...
;;obj: atualiza a pontuacao de um condutor dconforme com a gravidade da infracao cometida
;;exemplo:
