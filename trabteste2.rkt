...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname trabteste2) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "draw.rkt" "teachpack" "htdp")))))
...
(define (move-ate-fora bolha obj1 obj2 obj3 obj4 obj5)
  (cond
    ...
    [(symbol=? 'fraco (disco-resist bolha))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj1) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj1) (disco-posn2 bolha))))
        (+(obj-larg obj1)(obj-alt obj1)(disco-tamobj bolha))) true])]
    [(and(symbol=? 'forte (disco-resist bolha))(symbol=? 'forte (obj-resist obj1)))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj1) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj1) (disco-posn2 bolha))))
        (+(obj-larg obj1)(obj-alt obj1)(disco-tamobj bolha))) true])]
    ...
    [(symbol=? 'fraco (disco-resist bolha))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj2) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj2) (disco-posn2 bolha))))
        (+(obj-larg obj2)(obj-alt obj2)(disco-tamobj bolha))) true])]
    [(and(symbol=? 'forte (disco-resist bolha))(symbol=? 'forte (obj-resist obj2)))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj2) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj2) (disco-posn2 bolha))))
        (+(obj-larg obj2)(obj-alt obj2)(disco-tamobj bolha))) true])]
    ...
    [(symbol=? 'fraco (disco-resist bolha))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj3) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj3) (disco-posn2 bolha))))
        (+(obj-larg obj3)(obj-alt obj3)(disco-tamobj bolha))) true])]
    [(and(symbol=? 'forte (disco-resist bolha))(symbol=? 'forte (obj-resist obj3)))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj3) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj3) (disco-posn2 bolha))))
        (+(obj-larg obj3)(obj-alt obj3)(disco-tamobj bolha))) true])]
    ...
    [(symbol=? 'fraco (disco-resist bolha))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj4) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj4) (disco-posn2 bolha))))
        (+(obj-larg obj1)(obj-alt obj4)(disco-tamobj bolha))) true])]
    [(and(symbol=? 'forte (disco-resist bolha))(symbol=? 'forte (obj-resist obj4)))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj4) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj4) (disco-posn2 bolha))))
        (+(obj-larg obj4)(obj-alt obj4)(disco-tamobj bolha))) true])]
    
    [(symbol=? 'fraco (disco-resist bolha))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj5) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj5) (disco-posn2 bolha))))
        (+(obj-larg obj5)(obj-alt obj5)(disco-tamobj bolha))) true])]
    [(and(symbol=? 'forte (disco-resist bolha))(symbol=? 'forte (obj-resist obj5)))
     (cond
      [(< (sqrt(+(sqr(-(obj-posn1 obj5) (disco-posn1 bolha))))
                 (sqr(-(obj-posn2 obj5) (disco-posn2 bolha))))
        (+(obj-larg obj5)(obj-alt obj5)(disco-tamobj bolha))) true])]
